        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <span class="navbar-text">
                    raizha khalifah al ardhy sayyidina
                </span>
            </div>
        </nav>

        <h1 class="alert alert-info" style="text-align: center">raizha khalifah al ardhy sayyidina/2101060014</h1>
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered" border="1" cellspacing="0" cellpadding="10">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>raizha khalifah al ardhy sayyidina</td>
                                <td>2101060014</td>
                                <td>Btn sandik</td>
